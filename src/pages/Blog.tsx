...
const POSTS: BlogPostEntry[] = [
  {
    ...
    author: 'Fin Tools Lab Team',
    featured: true,
  },
  {
    slug: 'mortgage-calculator-for-new-york-residents-2026-guide',
    title: 'Mortgage Calculator for New York Residents: 2026 Guide',
  ...
  // Existing programmatic SEO posts (superseded 2025 twins are 301-redirected, so hide them)
  ...blogPostsData
    .filter((p: any) => ![
      'best-compound-interest-calculator-comparison-2025-top-free-tools',
      'mortgage-calculator-for-new-york-residents-2025-guide',
      'mortgage-calculator-for-new-york-residents-2026-guide',
